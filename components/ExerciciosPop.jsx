  ...
  return (
    <Popover.Portal>
      {props.state === "habilitado" ? (
        ...
        <Popover.Content
          sideOffset={20}
          className="w-fit rounded-lg bg-gray-200 p-4 shadow-[0_0_10px_2px_rgba(0,0,0,0.55)] data-[state=open]:animate-fadeIn data-[state=closed]:animate-fadeOut"
        >
        ...
        <Popover.Content
          sideOffset={20}
          className="w-fit rounded-lg bg-success-200 p-4 shadow-[0_0_10px_2px_rgba(0,0,0,0.55)] data-[state=open]:animate-fadeIn data-[state=closed]:animate-fadeOut"
        >
